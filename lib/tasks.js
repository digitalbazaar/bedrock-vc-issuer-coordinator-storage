...
bedrock.events.on('bedrock-mongodb.ready', async () => {
  ...
  // FIXME: add index for created time
  // FIXME: add test for finding records based on created time
  // FIXME: add find() and include decryption
...
/**
 * Retrieves a task record (if it exists).
 *
 * @param {object} options - Options to use.
